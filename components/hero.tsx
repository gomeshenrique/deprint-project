      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-5xl mx-auto text-center space-y-8">
            ...
            {/* Subheading */}
            <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto text-pretty leading-tight">
              Gráfica rápida em Maricá, RJ. Comunicação visual, impressão
              digital e offset com excelência em atendimento e prazo de entrega.
            </p>
